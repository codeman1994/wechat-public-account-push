export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxa7c06c7d5360d552",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "7c7e2c178841576dec0d009f139e5b6f",
  ...
  USERS: [
    {
      ...
      id: "1	胖熊	ofjGO6cn4nQeK-QmZmhDMZSAAbi8",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "fj1YZBoGBNCNJYo4QfM--LY_iexwF82wDIE-xyIazWI",
      // 所在省份
      province: "广东",
      // 所在城市
      city: "肇庆",
